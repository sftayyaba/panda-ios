...
class PNFavoriteDishesCollectionViewDelegateDatasource: UICollectionView,UICollectionViewDataSource,UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    var cusines = [String]()
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "PNFavoriteDishesCollectionViewCell", for: indexPath) as! PNFavoriteDishesCollectionViewCell
        self.configureCell(cell: cell, forIndexPath: indexPath as IndexPath)
        return cell
    }
    
    func configureCell(cell: PNFavoriteDishesCollectionViewCell, forIndexPath indexPath: IndexPath) {
