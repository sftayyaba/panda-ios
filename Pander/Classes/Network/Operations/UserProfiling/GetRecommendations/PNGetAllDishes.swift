...
class PNGetAllDishesOperation: OnebyteNetworkOperationBase {
...
//            if code >= PNApiResponseCodes.successResponse.rawValue{
                let codeResponseObject: PNAllDishes = PNAllDishes(json: JSON(response))
...
//        }
    ...
    private func startLoginOperation() {
        ...
        let urlWithId:String = AppNetworkEndPoints.kGetAllDishes
