...
class PNGetAllCuisinesOperation: OnebyteNetworkOperationBase {
...
//            if code >= PNApiResponseCodes.successResponse.rawValue{
                let codeResponseObject: PNAllCuisines = PNAllCuisines(json: JSON(response))
...
//        }
    ...
    private func startLoginOperation() {
        ...
        let urlWithId:String = AppNetworkEndPoints.kGetAllCuisines
