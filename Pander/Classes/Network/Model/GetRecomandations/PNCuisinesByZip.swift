...
public class PNCuisinesByZip: NSObject {
	...
	internal let kPNCuisinesByZip54321Key: String = " 54321 "
    ...
    */
    public init(json: JSON) {
		54321 = []
		if let items = json[kPNCuisinesByZip54321Key].array {
			for item in items {
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
		...
		if 54321?.count > 0 {
			...
			dictionary.updateValue(temp, forKey: kPNCuisinesByZip54321Key)
		}
		if 12345?.count > 0 {
			var temp: [AnyObject] = []
			for item in 12345! {
